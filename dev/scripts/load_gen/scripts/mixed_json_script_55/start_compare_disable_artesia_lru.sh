...
METHOD_NAME="disable-artesia-lru-mixed-55"
RESULT_BUCKET="result_128G_mixed_55"

PYTHON="${PYTHON:-/sgl-workspace/sglang/.venv/bin/python}"

ARTESIA_PORT=50402
SERVER_PORT=12352
RESULT_DIR="$ROOT_DIR/${RESULT_BUCKET}/result-disable-artesia-lru"
LOG_DIR="$ROOT_DIR/logs/$METHOD_NAME/$RESULT_BUCKET"
JSON_FILE_A="$ROOT_DIR/output_json_flatten/test8.json"
JSON_FILE_B="$ROOT_DIR/output_json_flatten/test10.json"
JSON_RATIO="1:1"
TRACE_SEED=12345
...
echo "Replay JSON A: ${JSON_FILE_A}"
echo "Replay JSON B: ${JSON_FILE_B}"
echo "Replay ratio: ${JSON_RATIO}, seed=${TRACE_SEED}"
