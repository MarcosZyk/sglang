...
async def test_context_lifecycle_and_one_off() -> None:
    runtime = build_runtime(enable_artesia=True, gpu_capacity_gb=0.00001)
    await runtime.create_context("ctx", "durable")
...
async def test_non_artesia_prefill_touches_only_active_context_timestamp() -> None:
    ...
    active_timestamp = active_context.state_changed_at_ns
    ...
    assert runtime.contexts["ctx"].state_changed_at_ns == active_timestamp + 2
