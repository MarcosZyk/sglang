...
class DeepseekV2AttentionMLA(nn.Module):
    ...
    def forward_absorb_prepare(
        ...
        if self.use_deep_gemm_bmm:
            ...
            ).view(q_nope.shape[0], self.num_local_heads, self.kv_lora_rank).transpose(0, 1)
    ...
    def forward_absorb_core(
        self, q_pe, k_pe, q_nope_out, k_nope, forward_batch, zero_allocator, positions, q=None,
    ):
...
class DeepseekV2ForCausalLM(nn.Module):
    ...
    def post_load_weights(self, is_nextn=False, weight_names=None):
        ...
        for layer_id in layer_ids:
            ...
            if _amx_parallel:
                self_attn.w_kd = self_attn.w_kc
                self_attn.w_vd = self_attn.w_vc
