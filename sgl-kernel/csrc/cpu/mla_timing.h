...
struct TimingIds {
    ...
    int accum_thread, accum_loop, accum_o, kernel_total;
    ...
    TimingIds() {
        ...
        accum_loop = mla_timing::mla_timing_register_stage("accum_loop");
        accum_thread = mla_timing::mla_timing_register_stage("accum_thread");
