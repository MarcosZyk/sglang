...
SGLANG_CPU_OMP_THREADS_BIND='0-39|40-79|80-119' python3 -m sglang.launch_server \
    --model "$modelpath" --trust-remote-code --device cpu --disable-overlap-schedule \
    --tp 3 --mem-fraction-static 0.8 --max-total-tokens 63356 --port 30010 --disable-radix-cache 
