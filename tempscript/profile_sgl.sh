...
python3 -m sglang.bench_serving  --dataset-path /home/dchen/ShareGPT_V3_unfiltered_cleaned_split.json \
                --dataset-name random --random-input 1024 --random-output 16 --num-prompts 1 \
                --request-rate inf --random-range-ratio 1.0 --max-concurrency 50 --host 33.197.201.175 --port 30001